...
Как именно подключить (Android/iPhone/Windows) — пошагово: ${cfg.base_url}/help.html`,
  pay: 'Оплата: СБП (QR в боте/на сайте — сканируете приложением любого банка) или карта РФ (МИР/Visa/MC). Зачисление мгновенное.',
  connect: `Подключение (2 минуты):
1) Ваш QR: в боте — «📱 Мои устройства» (кнопка QR) или в кабинете на сайте.
2) Приложение: Android — наше «Sonic VPN» (APK), iPhone — Streisand (App Store), Windows — v2rayN.
3) Сканируйте QR в приложении (+ → QR) → включите VPN → готово.

Пошагово с картинками: ${cfg.base_url}/help.html`,
